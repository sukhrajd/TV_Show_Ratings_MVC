...
namespace TV_Show_Ratings_MVC.Controllers
{
    public class SubscribersController : Controller
    {
        ...
        public SubscribersController(TV_Show_Ratings_DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,SubscriberName,Email")] Subscriber subscriber)
        {
